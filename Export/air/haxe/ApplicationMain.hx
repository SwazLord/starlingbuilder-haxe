...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StarlingbuilderHaxe", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StarlingbuilderHaxe", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "StarlingbuilderHaxe";
		app.meta["name"] = "StarlingbuilderHaxe";
		app.meta["packageName"] = "com.sample.starlingbuilderhaxe";
		...
		#elseif air
		app.window.title = "StarlingbuilderHaxe";
		#else
